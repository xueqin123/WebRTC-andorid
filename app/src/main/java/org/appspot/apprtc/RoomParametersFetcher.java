...
//            requestTurnServers(roomJson.getString("ice_server_url"));
                ...
                Log.i(TAG, "turnServers.size(): " + turnServers.size());
...
//    }
    ...
    private LinkedList<PeerConnection.IceServer> getIceServers() {
        //省略掉请求服务器步骤，抽空看下nginx是不能下发
        LinkedList<PeerConnection.IceServer> iceServers = new LinkedList<>();
        iceServers.add(new PeerConnection.IceServer("turn:47.93.218.251:3478", "helloword", "helloword"));
        return iceServers;
    }
    ...
    private LinkedList<PeerConnection.IceServer> requestTurnServers(String url)
        ...
        connection.setRequestProperty("REFERER", "https://www.xueqingxue.cn");
        ...
        for (int i = 0; i < iceServers.length(); ++i) {
            ...
            for (int j = 0; j < turnUrls.length(); j++) {
                ...
                Log.d(TAG, "turnUrl = " + turnUrl + " username = " + username + " credential =" + credential);
