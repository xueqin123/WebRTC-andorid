        ...
        public void run() {
          ...
          if (isInitiator) {
            ...
            if (peerConnection.getRemoteDescription() == null) {
              ...
              Log.d(TAG, "Local SDP set succesfully peerConnection.getLocalDescription(): description "+peerConnection.getLocalDescription().description+" type: "+peerConnection.getLocalDescription().type);
              events.onLocalDescription(localSdp);
            } else {
              // We've just set remote description, so drain remote
              // and send local ICE candidates.
              Log.d(TAG, "Remote SDP set succesfully peerConnection.getRemoteDescription(): description " +peerConnection.getRemoteDescription().description+" type: "+peerConnection.getRemoteDescription().type);
              drainCandidates();
            }
          } else {
